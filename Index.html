...
<body class="bg-primary1">
    <!-- navbar -->
    <nav class="bg-primary2 sticky top-0 px-10 sm:px-4 py-2.5 shadow-lg z-50">
        <div class="container flex flex-wrap justify-between items-center mx-auto">
            <!-- logo -->
            <a href="#" class="flex items-center ml-10">
                <img src="img/logoNavbar.svg" class="mr-3 w-full h-16 sm:h-16" alt="Brawijaya Tournament Logo">
            </a>
    ...
    <section class="">
        ...
        <div class="maskot bg-primary1 md:-mt-16  ">
            ...
            <div class=" container mx-auto py-20 md:py-14 md:mb-28">
